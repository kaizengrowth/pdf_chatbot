...
const PDFLoader = () => {
  ...
  const [prompt, setPrompt] = useState("How to make the world a better place?");
  const [messages, setMessages] = useState([
    {
      text: "Hi, I'm a Dumb AI. What would you like to know?",
      type: "bot",
    },
  ]);
      ...
      <TwoColumnLayout
        leftChildren={
          <>
            <PageHeader
              heading="Dumb AI"
              boldText="How to make a positive impact?"
